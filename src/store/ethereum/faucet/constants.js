...
export const FAUCET_ADDRESS_ACCESS_REQUESTED = 'FAUCET_ADDRESS_ACCESS_REQUESTED'
export const FAUCET_ADDRESS_ACCESS_GRANTED = 'FAUCET_ADDRESS_ACCESS_GRANTED'
export const FAUCET_ADDRESS_ACCESS_REVOKED = 'FAUCET_ADDRESS_ACCESS_REVOKED'
...
export const Constants = {
  ...
  FAUCET_ADDRESS_ACCESS_REQUESTED,
  FAUCET_ADDRESS_ACCESS_GRANTED,
  FAUCET_ADDRESS_ACCESS_REVOKED,
